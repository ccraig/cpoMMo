...
$form->addField(array(
	'list_name' => array(
		'label' => Pommo::_T('Name of Mailing List:'),
		'hint' => Pommo::_T('(ie. Brice\'s Mailing List)'),
		'rules' => 'text:notEmpty'
	),
	'site_name' => array(
		'label' => Pommo::_T('Name of Website:'),
		'hint' => Pommo::_T('(ie. The poMMo Website)'),
		'rules' => 'text:notEmpty'
	),
	'site_url' => array(
		'label' => Pommo::_T('Website URL:'),
		'hint' => Pommo::_T('(ie. http://www.pommo-rocks.com/)'),
		'rules' => 'text:notEmpty'
	),
	'admin_password' => array(
		'label' => Pommo::_T('Administrator Password:'),
		'hint' => Pommo::_T('(you will use this to login)'),
		'rules' => 'password:notEmpty'
	),
	'admin_password2' => array(
		'label' => Pommo::_T('Verify Password:'),
		'hint' => Pommo::_T('(enter password again)'),
		'rules' => 'password:notEmpty,isEqual:admin_password',
		'error' => Pommo::_T('Passwords must match.')
	),
	'admin_email' => array(
		'label' => Pommo::_T('Administrator Email:'),
		'hint' => Pommo::_T('(enter your valid email address)'),
		'rules' => 'text:isEmail'
	)
));
