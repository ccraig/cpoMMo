...
<fieldset>
<h3>{t}Your Information{/t}</h3>
<input type="hidden" name="updateForm" value="true" />

<div class="notes">
<p>{t escape=no 1="<span class=\"required\">" 2="</span>"}Fields marked like %1 bold %2 are required.{/t}</p>
</div>
...
<div class="buttons">
<button type="submit" name="update" value="{t}Update Records{/t}" class="positive"><img src="{$url.theme.shared}/images/icons/tick.png" alt="Update Records"/>{t}Update Records{/t}</button>
</div>
