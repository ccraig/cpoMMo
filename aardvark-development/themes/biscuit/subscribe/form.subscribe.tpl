...
<button type="submit" name="pommo_signup" value="{t}Subscribe{/t}" class="negative"><img src="{$url.theme.shared}/images/icons/cross.png" alt="Subscribe"/>{t}Subscribe{/t}</button>
</div>
