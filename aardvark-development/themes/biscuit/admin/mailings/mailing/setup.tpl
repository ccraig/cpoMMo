...
<input type="text" name="subject" value="{$subject|escape}" size="30" maxlength="60" />&nbsp;<a href="#" class="tooltip" title="{t}maximum of 60 characters{/t}"><img src="{$url.theme.shared}/images/icons/help-small.png" alt="tip" /></a>
...
{/foreach}
</select>&nbsp;<a href="#" class="tooltip" title="{t}select who should receive the mailing{/t}"><img src="{$url.theme.shared}/images/icons/help-small.png" alt="tip" /></a>
...
<input type="text" name="fromname" value="{$fromname|escape}" size="30" maxlength="60" />&nbsp;<a href="#" class="tooltip" title="{t}maximum of 60 characters{/t}"><img src="{$url.theme.shared}/images/icons/help-small.png" alt="tip" /></a>
<!--<span class="notes">{t}(maximum of 60 characters){/t}</span>-->
</div>

<div class="formSpacing">
<label for="fromemail"><span class="required">{t}From Email:{/t}</span>{fv message="fromemail"}</label>
<input type="text" name="fromemail" value="{$fromemail|escape}" size="30" maxlength="60" />&nbsp;<a href="#" class="tooltip" title="{t}maximum of 60 characters{/t}"><img src="{$url.theme.shared}/images/icons/help-small.png" alt="tip" /></a>
<!--<span class="notes">{t}(maximum of 60 characters){/t}</span>-->
</div>

<div class="formSpacing">
<label for="frombounce"><span class="required">{t}Return:{/t}</span>{fv message="frombounce"}</label>
<input type="text" name="frombounce" value="{$frombounce|escape}" size="30" maxlength="60" />&nbsp;<a href="#" class="tooltip" title="{t}maximum of 60 characters{/t}"><img src="{$url.theme.shared}/images/icons/help-small.png" alt="tip" /></a>
<!--<span class="notes">{t}(maximum of 60 characters){/t}</span>-->
</div>
...
</select>&nbsp;<a href="#" class="tooltip" title="{t}select character set of mailings{/t}"><img src="{$url.theme.shared}/images/icons/help-small.png" alt="tip" /></a>
