...
<div id="barHead">
{t escape="no" 1='<span id="sent">0</span>'}%1 emails sent{/t}
...
<fieldset>
<h3>{t}Last 50 notices{/t}</h3><br />

	<div class="buttons">
		<a href="ajax/status_download.php?type=sent"><img src="{$url.theme.shared}images/icons/examine_small.png" alt="view last" />{t}View Sent Emails{/t}</a>
		<a href="ajax/status_download.php?type=unsent"><img src="{$url.theme.shared}images/icons/examine_small.png" alt="view unsent" />{t}View Unsent Emails{/t}</a>
		<a href="ajax/status_download.php?type=error"><img src="{$url.theme.shared}images/icons/examine_small.png" alt="view failed" />{t}View Failed Emails{/t}</a>
	</div>
