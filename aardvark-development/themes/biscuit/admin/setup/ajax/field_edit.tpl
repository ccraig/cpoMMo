...
<div class="buttons">
<button type="submit" class="positive"><img src="{$url.theme.shared}/images/icons/tick.png" alt="update"/>{t}Update{/t}</button>
...
<form class="json confirm" action="ajax/fields.rpc.php?call=delOption" method="post">
    ...
    <div class="buttons">
	<button type="submit" value="{t}Delete{/t}" class="negative"><img src="{$url.theme.shared}/images/icons/cross.png" alt="update"/>{t}Delete{/t}</button>
	<img src="{$url.theme.shared}images/loader.gif" name="loading" class="hidden" title="{t}loading...{/t}" alt="{t}loading...{/t}" />
    </div>
	<div class="output"></div>
	</div>
