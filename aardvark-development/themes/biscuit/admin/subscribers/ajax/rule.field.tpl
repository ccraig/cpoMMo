...
<div class="buttons">
	<button type="submit" value="{if $firstVal}{t}Update{/t}{else}{t}Add{/t}{/if}" class="positive"><img src="{$url.theme.shared}/images/icons/tick.png" alt="add"/>{if $firstVal}{t}Update{/t}{else}{t}Add{/t}{/if}</button>
