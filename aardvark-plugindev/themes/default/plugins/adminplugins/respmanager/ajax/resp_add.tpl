...
<p>{t}Welcome to adding responsible persons. You can extend users to responsible persons one-by-one here.{/t}</p>
...
<form method="post" action="" id="addForm">
	...
	<legend>{t}Add User{/t}</legend>
		...
		<div class="actioncontainer" style="border: 1px solid silver; background-color:#eeeeee;padding:8px;" >
			...
			<div>
				Privileges: blah blah
			</div>
	
			<div>
				<label for="username"><strong class="required">{t}U{/t}</strong></label>
